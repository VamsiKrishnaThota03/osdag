...
const DesignPreferences = ({ visible, onCancel, onSave, initialValues }) => {
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>Design Preferences</div>
      <div style={styles.content}>
        <Tabs activeKey={activeTab} onChange={handleTabChange} type="card" style={styles.tabsContainer}>
          <TabPane tab="Beam Section" key="beam" style={styles.tabPane}>
            <Form
              form={form}
              layout="vertical"
              initialValues={{
          ...
          <TabPane tab="Connector" key="connector" style={styles.tabPane}>
            <Form
              form={form}
              layout="vertical"
              initialValues={{
          ...
          <TabPane tab="Bolt" key="bolt" style={styles.tabPane}>
            <Form
              form={form}
              layout="vertical"
              initialValues={{
          ...
          <TabPane tab="Detailing" key="detailing" style={styles.tabPane}>
            <Form
              form={form}
              layout="vertical"
              initialValues={{
          ...
          <TabPane tab="Design" key="design" style={styles.tabPane}>
            <Form
              form={form}
              layout="vertical"
              initialValues={{
      ...
      <div style={styles.footer}>
        <Space>
          <Button onClick={onCancel} style={{ backgroundColor: '#141414', color: '#fff', border: '1px solid #303030' }}>
            Cancel
          </Button>
