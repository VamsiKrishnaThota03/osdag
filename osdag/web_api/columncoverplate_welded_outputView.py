...
class ColumnCoverPlateWeldedOutputData(APIView):

    def post(self, request):
        print("Inside post method of ColumnCoverPlateWelded OutputData")
        ...
        cookie_id = request.COOKIES.get('column_cover_plate_welded_session')
        module_api = get_module_api('Column Cover Plate Welded')
        input_values = request.data
        tempData = {
            'cookie_id': cookie_id,
            'module_id': 'Column Cover Plate Welded',
